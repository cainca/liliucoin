...
unlocked to sign the Dongcoin-Qt.app bundle.
...
allowing somebody to distribute a Dongcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the dongcoin-qt.exe file inside the installer had not been tampered with.
