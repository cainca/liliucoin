...
unlocked to sign the liliucoin-Qt.app bundle.
...
allowing somebody to distribute a liliucoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the liliucoin-qt.exe file inside the installer had not been tampered with.
